...
<head>
	...
	<link rel="stylesheet" href="../_css/DRM266_LBB/basestyle_2014_12_15.css">
<?php 
	$contentCtrl = ( isset($contentCtrl) ) ? $contentCtrl : "" ;
	if ( $contentCtrl == true ) { 
		echo "	<link rel=\"stylesheet\" href=\"../_css/DRM266_LBB/ContentCTRL.css\" type=\"text/css\" />\n"; 
	}
?>
<?php if ( isset($stylesheet) ) { 
	echo "	<link rel=\"stylesheet\" href=\"../_css/DRM266_LBB/pages/" . $stylesheet . "\">\n"; 
}
?>
<?php 
// RevTrax coupon code
