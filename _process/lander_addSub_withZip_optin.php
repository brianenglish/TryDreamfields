<?php include('../_includes/exacttarget_soap_client.php'); ?>
<?php include('drm_alert_lockout.php'); ?>
<?php
...
//
// Unless specified on the landing page, we send the TryDRM welcome
// Triggered Sends > Nurture_TriggeredSends > DRM220_WebsiteSignup_Welcome
// $cust_key = "DRM220_TryDrmSignup_Welcome";
//
function dream_triggersend($email, $group, $zip, $cust_key = "DRM220_TryDrmSignup_Welcome") {
$wsdl = '../_includes/etframework.wsdl';
