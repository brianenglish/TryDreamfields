...
$lid = "18715811";
$lid_comment = "(2015/05/08 ... My Lists > 2010_Landing_Pages > TryDrm_Landing_Pages > Facebook-2015-Ads-Kids";
$group = ""; // default is Eat Healthier (other options: Managing Diabetes, Low Carb Diet)
$source = "TryDrm-facebook-kid-friendly-recipes";
$revtrax_source = "Facebook-Kids";
$campaign = "Facebook_Kids_2015_ads";
...
<script>(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
	...
	<div class="site_body kids">
	<div id="border-gold">
		
		
		<!-- BEGIN page content -->
		<div id="hero">
			<a class="hero-link" title="Try Cheesy Pasta with Chicken and Broccoli" href="http://www.dreamfieldsfoods.com/healthy-pasta-recipes/2013/04/cheesy-pasta-with-chicken-broccoli.html" target="_blank"><img src="../_img/DRM080/DRM080_FB_Kids_hero.jpg"></a>
		</div>
		...
		<div class="main-content">
			...
			<div class="ca_1">
                ...
                <div class="div-fb-like">
                <div class="fb-like" data-href="http://www.trydreamfields.com/facebook-kid-friendly-recipes/" data-layout="button_count" data-action="like" data-show-faces="true" data-share="true"></div>
                </div>
                
				<h1 class="larger">Eat a Little Better with Healthy Pasta that Kids Love!</h1>
                <p style="text-align: center;">
                When you start with Dreamfields, it's easy to create quick and healthy recipes.
                </p>
