...
$lid = "18615415";
$lid_comment = "(2015/01/12 ... My Lists > 2010_Landing_Pages > TryDrm_Landing_Pages > TryDrm_2015_PPC > TryDrm_ppc_DreamfieldsDisplay";
$group = ""; // default is Eat Healthier (other options: Managing Diabetes, Low Carb Diet)
$source = "TryDrm-ppc_DreamfieldsDisplay";
$revtrax_source = (!empty($_GET['source']) ) ? $_GET['source'] : ""; // ex: Google
$campaign = (!empty($_GET['campaign']) ) ? $_GET['campaign'] : ""; // was DisplayPPC
