...
$lid = "18616698";
$lid_comment = "(2015/01/12 ... My Lists > 2010_Landing_Pages > TryDrm_Landing_Pages > TryDrm_2015_PPC > TryDrm_ppc_HealthySearch";
$group = ""; // default is Eat Healthier (other options: Managing Diabetes, Low Carb Diet)
$source = "TryDrm-ppc_HealthySearch";
$revtrax_source = (!empty($_GET['source']) ) ? $_GET['source'] : ""; // ex: Google
$campaign = (!empty($_GET['campaign']) ) ? $_GET['campaign'] : ""; // was HealthyPPC
			...
			<div class="ca_1">
				...
				<div class="thumbnails">
					...
					<div class="thumbnail">
						...
						<p>7 grams of protein per serving. This is natural occurring protein in our quality durum wheat.
</p>
					</div>
					...
					<div class="thumbnail">
						...
						<p class="taste">Get the same taste and texture of traditional pasta with Dreamfields.
</p>
					</div>
				</div>
