...
function getSub($email) {
		$data_string = "<exacttarget><authorization><username>hdi-drm</username><password>campbuzz@1</password></authorization><system><system_name>subscriber</system_name><action>retrieve</action><search_type>listid</search_type><search_value></search_value><search_value2>{$email}</search_value2><showChannelID></showChannelID></system></exacttarget>";
