...
$lid = "18601923";
$lid_comment = "(2015/01/06 ... My Lists > 2010_Landing_Pages > TryDrm_Landing_Pages > TryDrm_2015_PPC > TryDrm_ppc_Dreamfields";
$group = ""; // default is Eat Healthier (other options: Managing Diabetes, Low Carb Diet)
$source = "TryDrm-ppc_Dreamfields";
$revtrax_source = (!empty($_GET['source']) ) ? $_GET['source'] : ""; // ex: Google
$campaign = (!empty($_GET['campaign']) ) ? $_GET['campaign'] : ""; // was DreamfieldsSearchPPC
