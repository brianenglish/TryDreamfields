...
<head>
	...
	<link rel="stylesheet" href="../_css/DRM270_Pastapalooza/basestyle_2014_12_15.css">
<?php 
	$contentCtrl = ( isset($contentCtrl) ) ? $contentCtrl : "" ;
	if ( $contentCtrl == true ) { 
		echo "	<link rel=\"stylesheet\" href=\"../_css/DRM270_Pastapalooza/ContentCTRL.css\" type=\"text/css\" />\n"; 
	}
?>
<?php if ( isset($stylesheet) ) { 
	echo "	<link rel=\"stylesheet\" href=\"../_css/DRM270_Pastapalooza/pages/" . $stylesheet . "\">\n"; 
}
?>
<?php 
// RevTrax coupon code
